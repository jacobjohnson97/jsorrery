...
export default {
	name: 'MoonSun',
	title: 'If Moon was as massive as the sun (Jacob)',
	commonBodies: [
		moon,
		sun,
		mercury,
	...
	help: "This scenario shows what would happen if, instantaneously at this moment, the moon became as massive as the sun. (Jacob's scenario).",
};
